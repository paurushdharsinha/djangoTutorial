...
#      -H "Authorization: Token 962fb18620e985aef9d7ce7ca8a5b49b06457e47" \
#      -d '{
#            "skills": {
#              "Skill1": 25,
#              "Skill2": 25,
...
# curl -X GET http://127.0.0.1:8000/api/user/ -H "Content-Type: application/json" -H "Authorization: Token 962fb18620e985aef9d7ce7ca8a5b49b06457e47"